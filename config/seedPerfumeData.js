module.exports =  [
    ...
    },
    {
        ...
        "name": "Black Opium",
        "price": 139.00,
        "description": "What it is: Black Opium Eau de Parfum is the seductively intoxicating women's fragrance. The opening notes of adrenaline-rich coffee and the sweet sensuality of vanilla recline into the softness of white flowers creating a long-lasting perfume.What it does: This seductive women's perfume is inspired by the edgy and daring woman. Emboldened by the strong scent of coffee, the sensuous warm floral vanilla perfume captivates the senses with a sweet vanilla base and a burst of floral at the heart of the fragrance.",
        "size": "3.0 fl oz",
    ...
    },
    {
        ...
        "name": "Mon Paris",
        "price": 108.00,
        "description": "What it is: Mon Paris Eau de Parfum is a sweet floral perfume for women. Sweet notes of red berries are softened by datura flower and anchored by the woody scent of white musk blended beautifully together with patchouli to create a long-lasting women's fragrance that is romantic in every way.What it does:Inspired by Paris, this sensuous, romantic perfume reflects the intense passion found in the city of love. An unforgettable whirlwind journey to Paris, the feminine and floral perfume embodies desire and seduces the senses.",
        "size": "1.6 fl oz",
    ...
    },
    {
        ...
        "name": "Eros",
        "price": 130.00,
        "description": "The primal power of woman is captured in this radiant, sensual essence. Attraction, desire, and passion intertwine in an alchemical mix of tempting, bright, and feminine notes. A refined accord of lemon and jasmine is exalted by sensual and smooth woods for a fragrance of strength, individuality, and seduction.'Eros Pour Femme is the ultimate in power and seduction from Versace, from the captivating fragrance to the elegance of the bottle and the stunning campaign by Mert Alas and Marcus Piggott starring Lara Stone.'—Donatella Versace, Chief Designer for Versace About the Bottle: The bottle is crafted within the mythological codes of the Versace DNA. The gold Medusa and the Greek key design are engraved on the edge, stamping their imposing authority on the bottle.",
        "size": "3.4 fl oz",
    ...
    },
    {
        ...
        "price": 285.00,
        "description": "VIBRANT. SPARKLING. TRANSPORTIVE.TO TOM FORD, THIS SCENT PERFECTLY CAPTURES THE COOL BREEZES, SPARKLING CLEAR WATER AND LUSH FOLIAGE OF THE ITALIAN RIVERA. HIS REINVENTION OF A CLASSIC EAU DE COLOGNE FEATURES CRISP CITRUS OILS, SURPRISING FLORAL NOTES AND AMBER UNDERTONES TO LEAVE A SPLASHY YET SUBSTANTIVE IMPRESSION.",
        "size": "1.7 fl oz",
